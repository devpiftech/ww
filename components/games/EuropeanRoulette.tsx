...
const EuropeanRoulette: React.FC<RouletteProps> = ({ user, coins, setCoins }) => {
  ...
  const handleSpin = async () => {
    ...
    // Generate a random number (0-36 for European roulette)
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="play" className="space-y-4">
          ...
          <Card className="bg-card border border-border/30 shadow-xl">
            <CardHeader>
              <CardTitle className="text-center">European Roulette</CardTitle>
              ...
              {(isSpinning || spinResult !== null) && (
                <div className="flex justify-center mb-6">
                  {isSpinning ? (
                    ...
                    <SpinResultDisplay spinResult={spinResult} isAmerican={false} />
                  )}
                </div>
              )}
              
              {/* Roulette Board - Using our new component */}
              <RouletteBoard 
                isAmerican={false}
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your recent European Roulette games</CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
